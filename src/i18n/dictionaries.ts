...
const en = {
  ...
  footer: {
    ...
    newsletterError: 'Could not subscribe — try again in a moment.',
...
const ar: Dictionary = {
  ...
  cta: {
    ...
    error: 'حدث خطأ — لم يتم إرسال رسالتك.',
    errorDirect: 'راسلنا مباشرة',
  },
  footer: {
    ...
    newsletterSuccess: 'تم الاشتراك — أهلاً بك.',
    newsletterError: 'تعذر الاشتراك — حاول مرة أخرى بعد قليل.',
